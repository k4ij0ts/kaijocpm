...
from kaijocpm import Kaijo

__CHANNEL_USERNAME__ = "KAIJO_CPM"
__GROUP_USERNAME__   = "KAIJO_CPM"
...
def banner(console):
    ...
    brand_name = figlet_format('KAIJOCPM', font='bloody')
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @KAIJO_CPM ')) 
...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '========[ KAIJO TOOL DETAILS ]========'))
...
def load_client_details():
    ...
    print(Colorate.Horizontal(Colors.rainbow, '===============[ KAIJO TOOL ]==============='))
